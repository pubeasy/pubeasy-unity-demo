...
using TradplusOfferwalliOS = PubeasySDK.iOS.PubeasyOfferwalliOS;

namespace PubeasySDK.iOS
{

    public class PubeasyOfferwalliOS
    {
        private static PubeasyOfferwalliOS _instance;

        public static PubeasyOfferwalliOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyOfferwalliOS();
            }
            return _instance;
        }
