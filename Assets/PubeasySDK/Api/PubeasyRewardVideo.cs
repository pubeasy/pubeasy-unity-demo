...
namespace PubeasySDK.Api
{
...
#elif UNITY_IOS
        PubeasyRewardVideoiOS
#elif UNITY_ANDROID
        PubeasyRewardVideoAndroid
#else
        TPSdkUnityRewardVideo
#endif
    { }
    ...
    public class PubeasyRewardVideo
    {
        private static PubeasyRewardVideo _instance;

        public static PubeasyRewardVideo Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyRewardVideo();
            }
            return _instance;
        }
