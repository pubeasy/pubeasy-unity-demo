...
namespace PubeasySDK.iOS
{
    public class PubeasyInterstitialiOS
    {
        private static PubeasyInterstitialiOS _instance;

        public static PubeasyInterstitialiOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyInterstitialiOS();
            }
            return _instance;
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialLoaded != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialLoaded(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialLoadFailed != null)
            {
                Dictionary<string, object> error = Json.Deserialize(errorStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialLoadFailed(adUnitId, error);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialImpression != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialImpression(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialShowFailed != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                Dictionary<string, object> error = Json.Deserialize(errorStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialShowFailed(adUnitId, adInfo, error);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialClicked != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialClicked(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialClosed != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialClosed(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialStartLoad != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialStartLoad(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialBiddingStart != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialBiddingStart(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialBiddingEnd != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                Dictionary<string, object> error = Json.Deserialize(errorStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialBiddingEnd(adUnitId, adInfo, error);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialOneLayerStartLoad != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialOneLayerStartLoad(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialOneLayerLoaded != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialOneLayerLoaded(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialOneLayerLoadFailed != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                Dictionary<string, object> error = Json.Deserialize(errorStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialOneLayerLoadFailed(adUnitId, adInfo, error);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialVideoPlayStart != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialVideoPlayStart(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialVideoPlayEnd != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(adInfoStr) as Dictionary<string, object>;
                PubeasyInterstitialiOS.Instance().OnInterstitialVideoPlayEnd(adUnitId, adInfo);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialAllLoaded != null)
            {
                PubeasyInterstitialiOS.Instance().OnInterstitialAllLoaded(adUnitId, isSuccess);
            }
        }
        ...
        {
            if (PubeasyInterstitialiOS.Instance().OnInterstitialIsLoading != null)
            {
                PubeasyInterstitialiOS.Instance().OnInterstitialIsLoading(adUnitId);
            }
        }
