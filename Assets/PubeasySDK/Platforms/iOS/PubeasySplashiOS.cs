...
using TradplusSplashiOS = PubeasySDK.iOS.PubeasySplashiOS;

namespace PubeasySDK.iOS
{
    public class PubeasySplashiOS
    {
        private static PubeasySplashiOS _instance;

        public static PubeasySplashiOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasySplashiOS();
            }
            return _instance;
        }
