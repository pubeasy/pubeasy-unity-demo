...
{
    public class PubeasyAdsiOS
    {
        private static PubeasyAdsiOS _instance;

        public static PubeasyAdsiOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyAdsiOS();
            }
            return _instance;
        }
        ...
        {
            if (PubeasyAdsiOS.Instance().OnInitFinish != null)
            {
                PubeasyAdsiOS.Instance().OnInitFinish(success);
            }
        }
        ...
        {
            if (PubeasyAdsiOS.Instance().OnDialogClosed != null)
            {
                PubeasyAdsiOS.Instance().OnDialogClosed(level);
            }
        }
        ...
        {
            if (PubeasyAdsiOS.Instance().OnCurrentAreaSuccess != null)
            {
                PubeasyAdsiOS.Instance().OnCurrentAreaSuccess(isEu,isCn,isCa);
            }
        }
        ...
        {
            if (PubeasyAdsiOS.Instance().OnCurrentAreaFailed != null)
            {
                PubeasyAdsiOS.Instance().OnCurrentAreaFailed(msg);
            }
        }
        ...
        {
            if (PubeasyAdsiOS.Instance().OnGlobalAdImpression != null)
            {
                Dictionary<string, object> adInfo = Json.Deserialize(msg) as Dictionary<string, object>;
                PubeasyAdsiOS.Instance().OnGlobalAdImpression(adInfo);
            }
        }
    }
}
