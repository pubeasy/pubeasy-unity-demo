...
using TradplusNativeiOS = PubeasySDK.iOS.PubeasyNativeiOS;

namespace PubeasySDK.iOS
{

    public class PubeasyNativeiOS
    {

        private static PubeasyNativeiOS _instance;

        public static PubeasyNativeiOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyNativeiOS();
            }
            return _instance;
        }
