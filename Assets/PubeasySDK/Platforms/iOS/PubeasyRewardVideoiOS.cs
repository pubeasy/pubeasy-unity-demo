...
using TradplusRewardVideoiOS = PubeasySDK.iOS.PubeasyRewardVideoiOS;

namespace PubeasySDK.iOS
{

    public class PubeasyRewardVideoiOS
    {
        private static PubeasyRewardVideoiOS _instance;

        public static PubeasyRewardVideoiOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyRewardVideoiOS();
            }
            return _instance;
        }
