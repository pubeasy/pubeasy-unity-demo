...
namespace PubeasySDK.Api
{
...
#elif UNITY_IOS
     PubeasyInterstitialiOS
#elif UNITY_ANDROID
     PubeasyInterstitialAndroid
#else
     TPSdkUnityInterstitial
#endif
    { }
    ...
    public class PubeasyInterstitial
    {
        private static PubeasyInterstitial _instance;

        public static PubeasyInterstitial Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyInterstitial();
            }
            return _instance;
        }
