...
using TradplusBanneriOS = PubeasySDK.iOS.PubeasyBanneriOS;

namespace PubeasySDK.iOS
{
    public class PubeasyBanneriOS
    {
        private static PubeasyBanneriOS _instance;

        public static PubeasyBanneriOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyBanneriOS();
            }
            return _instance;
        }
