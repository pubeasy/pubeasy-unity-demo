...
#if UNITY_EDITOR
using PubeasySDK.Unity;
#elif UNITY_IOS
using PubeasySDK.iOS;
#elif UNITY_ANDROID
using PubeasySDK.Android;
#else
using PubeasySDK.Unity;
#endif

namespace PubeasySDK.Api
{
    public class TPNativeBanner :
#if UNITY_EDITOR
        TPSdkUnityNativeBanner
#elif UNITY_IOS
        PubeasyNativeBanneriOS
#elif UNITY_ANDROID
        PubeasyNativeBannerAndroid
#else
        TPSdkUnityNativeBanner
#endif
    ...
    public class TPNativeBannerExtra
    {
        ...
        ///</summary>
        public PubeasyBase.AdPosition adPosition;
        ...
        public TPNativeBannerExtra()
        {
            width = 0;
            height = 50;
            adPosition = PubeasyBase.AdPosition.TopLeft;
            backgroundColor = "";
        }
    }

    public class PubeasyNativeBanner
    {
        private static PubeasyNativeBanner _instance;

        public static PubeasyNativeBanner Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyNativeBanner();
            }
            return _instance;
        }
