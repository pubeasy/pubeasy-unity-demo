...
using TradplusNativeBanneriOS = PubeasySDK.iOS.PubeasyNativeBanneriOS;

namespace PubeasySDK.iOS
{

    public class PubeasyNativeBanneriOS
    {

        private static PubeasyNativeBanneriOS _instance;

        public static PubeasyNativeBanneriOS Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyNativeBanneriOS();
            }
            return _instance;
        }
