...
namespace PubeasySDK.Api
{
    ...
    public class PubeasyOfferwall
    {
        private static PubeasyOfferwall _instance;

        public static PubeasyOfferwall Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyOfferwall();
            }
            return _instance;
        }
