...
namespace PubeasySDK.Api
{
    ...
    public class PubeasySplash
    {
        private static PubeasySplash _instance;

        public static PubeasySplash Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasySplash();
            }
            return _instance;
        }
