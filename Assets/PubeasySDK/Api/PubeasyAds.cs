...
namespace PubeasySDK.Api
{
    ...
    public class PubeasyAds
    {
        ...
        ///<summary>
        ///选择是否只使用Pubeasy国内服务器还是全球服务器，bool onlyCn, 默认false 使用全球服务器
        ///</summary>
        ...
        {
            TPAds.Instance().OpenPubeasyTool(appId);
        }
