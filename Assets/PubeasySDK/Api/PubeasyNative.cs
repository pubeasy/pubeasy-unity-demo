...
namespace PubeasySDK.Api
{
    ...
    public class PubeasyNative
    {

        private static PubeasyNative _instance;

        public static PubeasyNative Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyNative();
            }
            return _instance;
        }
