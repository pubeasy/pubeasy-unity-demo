...
namespace Tardplus.TradplusEditorManager.Editor
{
    public class TradplusEditorManagerWindow : EditorWindow
    {
        ...
        {
            manager = GetWindow<TradplusEditorManagerWindow>(utility: true, title: "Pubeasy Manager", focus: true);
        ...
        {
            EditorGUILayout.LabelField("Pubeasy SDK Versions", titleLabelStyle);
            GUILayout.Space(5);
            GUILayout.BeginHorizontal();
            GUILayout.Space(10);
            using (new EditorGUILayout.VerticalScope("box"))
            {
                ...
                DrawRowInfo("Unity Plugin", PubeasyAds.PluginVersion, "");
                //Android
