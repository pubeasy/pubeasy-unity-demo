...
namespace PubeasySDK.Api
{
    ...
    public class TPBannerExtra
    {
        ...
        ///居中模式 仅iOS支持
        ///</summary>
        public PubeasyBase.AdContentMode contentMode;
    ...
    public class PubeasyBanner
    {

        private static PubeasyBanner _instance;

        public static PubeasyBanner Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyBanner();
            }
            return _instance;
        }
