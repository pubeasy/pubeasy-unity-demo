...
namespace PubeasySDK.Api
{
...
#elif UNITY_ANDROID
    public class TPInterActive : PubeasyInterActiveAndroid
#else
    ...
    public class PubeasyInterActive
    {

        private static PubeasyInterActive _instance;

        public static PubeasyInterActive Instance()
        {
            if (_instance == null)
            {
                _instance = new PubeasyInterActive();
            }
            return _instance;
        }
